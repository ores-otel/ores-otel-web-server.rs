//! Four-avenue web ↔ API binding for `ores-otel`.
//!
//! 1. Direct read-only DB via `*-lib-core` named queries (no migrations).
//! 2. Stateless HTTP from `app.ores-otel.dev` to `api.ores-otel.dev`.
//! 3. Stateful TLS 1.3/mTLS TCP to `api.ores-otel.dev:7443`.
...
pub const GITHUB_ORG: &str = "ores-otel";
pub const ORG_SLUG: &str = "ores-otel";
pub const DNS_ZONE: &str = "ores-otel.dev";
